...
enum NT_FACILITY_CODES : unsigned long
{
...
enum ERROR_SEVERITY_MASK : unsigned long
{
    APPLICATION_ERROR_MASK          = 0x20000000L,
    ERROR_SEVERITY_SUCCESS          = 0x00000000L,
    ERROR_SEVERITY_INFORMATIONAL    = 0x40000000L,
    ERROR_SEVERITY_WARNING          = 0x80000000L,
    ERROR_SEVERITY_ERROR            = 0xC0000000L,
};
...
#define NTSTATUS_FROM_WIN32(x) ((long)(x) <= 0 ? ((NTSTATUS)(x)) : ((NTSTATUS) (((x) & 0x0000FFFF) | (FACILITY_NTWIN32 << 16) | ERROR_SEVERITY_ERROR)))
